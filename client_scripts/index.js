...
const runModule = () => {
    ...
    define("src/unify/client-init", ["require", "exports", "src/util", "src/unify/tags", "src/unify/unify-config", "src/unify/util", "src/kubejs-typings/src/integrations/jei"], function (require, exports, util_5, tags_1, unify_config_3, util_6) {
        "use strict";
        Object.defineProperty(exports, "__esModule", { value: true });
            ...
            onEvent("jei.hide.items", function (event) {
                ...
                try {
                    (0, util_5.forEach)(tags, function (tag) {
                        ...
                        var tItem = tagItems.get(tag);
                        (0, util_5.forEach)(stacks, function (s) {
                            var stackId = s.getId();
                            if (stackId === tItem || (0, util_5.has)(config.exclude, stackId))
                                return;
                            event.hide(stackId);
                        });
                    });
                    ...
                    console.error("Error message: " + ((_a = err) === null || _a === void 0 ? void 0 : _a.message));
                }
            });
        };
